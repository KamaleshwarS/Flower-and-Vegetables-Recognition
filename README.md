# Flowers and Vegetable Classification


   Hey there I'm created a recognition of fruits and vegetables using KAGGLE 
Data set model. It will be able to predict the fruits and vegetables that uploaded in the interface.
...
### Flower recognition
    ...
    Check out this drive link of my collab notebook (https://colab.research.google.com/drive/1COMQrmtI-KbI7t-4HtZYlKFJtVFc4wRd?usp=share_link)
